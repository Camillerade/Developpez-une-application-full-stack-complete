...
public class AuthService {
    ...
    public UserDTO updateUser(UserDTO userDTO) throws UsernameNotFoundException {
        ...
        user.setPassword(passwordEncoder.encode(userDTO.getPassword())); // Encoder et mettre à jour le mot de passe

        // Journalisation de la requête SQL
        System.out.println("SQL Query: UPDATE users SET admin = ?, email = ?, password = ?, updated_at = ?, username = ? WHERE id = ?");
        System.out.println("Values: " + userDTO.getId() + ", " + userDTO.getUsername() + ", " + userDTO.getEmail() + ", " + userDTO.getPassword() + ", " + userDTO.getCreatedAt() + ", " + userDTO.getUpdatedAt());
    ...
    public UserDTO getCurrentUser(String email) {
        ...
        return new UserDTO(user.getId(), user.getUsername(), user.getEmail(), user.getAdmin(), user.getCreatedAt(), user.getUpdatedAt());  // Ajouter user.getAdmin()
    }
